...
public class YearlyReport {
    ...
    public void loadReport(String path) {
        ...
        for (int i = 1; i < content.size(); i++) {
            ...
            MonthTotalPerYear monthTotal = new MonthTotalPerYear(Months.values()[Integer.parseInt(parts[0]) - 1].getName(), Integer.parseInt(parts[1]), Boolean.parseBoolean(parts[2]));
